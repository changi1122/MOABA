package kr.ac.chungbuk.moaba.service;

import kr.ac.chungbuk.moaba.model.Attempt;
import kr.ac.chungbuk.moaba.model.User;
import kr.ac.chungbuk.moaba.repository.AttemptRepository;
import kr.ac.chungbuk.moaba.repository.UserRepository;
import kr.ac.chungbuk.moaba.security.JwtTokenProvider;
import kr.ac.chungbuk.moaba.security.UserAuthentication;
...
public class UserService implements UserDetailsService {
    ...
    /**
     * 주어진 username인 user를 완전히 삭제합니다.
     * @param username
     * @throws Exception
     */
    public void safeDelete(String username) throws Exception {
        User user = userRepository.findByUsername(username)
                .orElseThrow(() -> new UsernameNotFoundException("User not present"));
